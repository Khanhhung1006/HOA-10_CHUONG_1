  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        '• Phân lớp s: Có 1 AO s ⟹ Chứa tối đa 2e (s2).',
        '• Phân lớp p: Có 3 AO p (px, py, pz) ⟹ Chứa tối đa 6e (p6).',
        '• Phân lớp d: Có 5 AO d ⟹ Chứa tối đa 10e (d10).',
        '• Phân lớp f: Có 7 AO f ⟹ Chứa tối đa 14e (f14).',
